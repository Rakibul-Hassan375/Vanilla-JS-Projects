...
function getPrice(){
    let showPticeDom = document.getElementById('show-price')
    let range = document.getElementById('price').value
    showPticeDom.innerHTML = range
    console.log(range)
    let html = ''
    allProductsData.map((v,i)=>{
        if(range >= v.price){
